...
var G__46040 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
ch = G__46040;
continue;
} else {
return ch;
...
var vec__46035 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46035,(0),null);
return (match === s);
});
...
var len__5766__auto___46041 = arguments.length;
var i__5767__auto___46042 = (0);
while(true){
if((i__5767__auto___46042 < len__5766__auto___46041)){
args__5772__auto__.push((arguments[i__5767__auto___46042]));

var G__46043 = (i__5767__auto___46042 + (1));
i__5767__auto___46042 = G__46043;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq46038){
var G__46039 = cljs.core.first(seq46038);
var seq46038__$1 = cljs.core.next(seq46038);
var self__5751__auto__ = this;
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46039,seq46038__$1);
}));
...
var G__46045__i = 0, G__46045__a = new Array(arguments.length -  1);
while (G__46045__i < G__46045__a.length) {G__46045__a[G__46045__i] = arguments[G__46045__i + 1]; ++G__46045__i;}
  _ = new cljs.core.IndexedSeq(G__46045__a,0,null);
} 
...
var rdr = cljs.core.first(arglist__46046);
var _ = cljs.core.rest(arglist__46046);
