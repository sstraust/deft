...
(reagent.impl.template.UnsafeHTML.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
var G__40340 = o;
reagent.impl.template.goog$module$goog$object.set(G__40340,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
G__40410.cljs$lang$applyTo = (function (arglist__40413){
var args = cljs.core.seq(arglist__40413);
return G__40410__delegate(args);
});
...
var G__40346 = o;
reagent.impl.template.goog$module$goog$object.set(G__40346,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__40417.cljs$lang$applyTo = (function (arglist__40422){
var args = cljs.core.seq(arglist__40422);
...
var G__40353 = props;
var G__40353__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40353,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40353);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40353__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40358 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40358,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40358;
}
})(),id_class);
...
var temp__5823__auto___40432 = (function (){var and__5041__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___40432)){
var d_40433 = temp__5823__auto___40432;
if((d_40433 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_40433.s}));
} else {
...
var G__40365 = (cljs.core.count(argv) - first_child);
switch (G__40365) {
case (0):
...
var vec__40367 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40367,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40367,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40367,(2),null);
...
var temp__5827__auto___40455 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___40455 == null)){
} else {
var key_40457 = temp__5827__auto___40455;
(jsprops.key = key_40457);
}
...
var temp__5827__auto___40458 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___40458 == null)){
} else {
var key_40459 = temp__5827__auto___40458;
(jsprops.key = key_40459);
}
...
var temp__5827__auto___40464 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___40464 == null)){
} else {
var key_40465 = temp__5827__auto___40464;
(jsprops.key = key_40465);
}
...
var temp__5827__auto___40489 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___40489 == null)){
} else {
var key_40490 = temp__5827__auto___40489;
(jsprops.key = key_40490);
}
...
var temp__5827__auto___40491 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___40491 == null)){
} else {
var key_40492 = temp__5827__auto___40491;
(jsprops.key = key_40492);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40378_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__40378_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__40380 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40380,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40380,(1),null);
...
break;
default:
var G__40505 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__40506 = compiler;
v = G__40505;
compiler = G__40506;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template40398 = (function (opts,id,fn_to_element,parse_fn,meta40399){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template40398.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40400,meta40399__$1){
var self__ = this;
var _40400__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40398(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta40399__$1));
}));

(reagent.impl.template.t_reagent$impl$template40398.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40400){
var self__ = this;
var _40400__$1 = this;
return self__.meta40399;
}));

(reagent.impl.template.t_reagent$impl$template40398.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40398.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40398.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template40398.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40398.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40398.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta40399","meta40399",153138249,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40398.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40398.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40398");

(reagent.impl.template.t_reagent$impl$template40398.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template40398");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40398.
 */
reagent.impl.template.__GT_t_reagent$impl$template40398 = (function reagent$impl$template$__GT_t_reagent$impl$template40398(opts,id,fn_to_element,parse_fn,meta40399){
return (new reagent.impl.template.t_reagent$impl$template40398(opts,id,fn_to_element,parse_fn,meta40399));
});
...
return (new reagent.impl.template.t_reagent$impl$template40398(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
