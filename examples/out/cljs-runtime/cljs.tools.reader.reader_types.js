...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45969 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45969(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45970 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45970(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45971 = (function (reader,ch){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45971(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45975 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45975(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45976 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45976(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45977 = (function (reader){
var x__5390__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45977(reader);
}
});
...
var G__45989 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__45990 = s.append(c);
c = G__45989;
s = G__45990;
continue;
}
