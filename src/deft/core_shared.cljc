;; NOTE: DO NOT RENAME OR DELETE THIS FILE
;; SOME PEOPLE MAY BE DEPENDING ON THE FACT THAT THEY CAN REQUIRE SOMETHING WITH THIS NAME
;; FROM AN EARLIER VERSION, THOUGH THEY SHOULD NOT BE DEPENDING ON THE FILES CONTENTS
(ns deft.core-shared
  (:require
